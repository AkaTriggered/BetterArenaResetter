...
import org.akatriggered.betterarenaresetter.commands.BorderCommand;
import org.akatriggered.betterarenaresetter.commands.CancelCommand;
import org.akatriggered.betterarenaresetter.commands.ConfirmCommand;
import org.akatriggered.betterarenaresetter.commands.CreateCommand;
import org.akatriggered.betterarenaresetter.commands.DebugCommand;
import org.akatriggered.betterarenaresetter.commands.DeleteCommand;
import org.akatriggered.betterarenaresetter.commands.InfoCommand;
import org.akatriggered.betterarenaresetter.commands.ListCommand;
import org.akatriggered.betterarenaresetter.commands.ReloadCommand;
import org.akatriggered.betterarenaresetter.commands.ResetCommand;
...
public abstract class ArenaCommand {
    ...
    private String description = "Manage BetterArenaResetter!";
    ...
    private static void help(CommandSender sender) {
        ...
        sender.sendMessage(BetterArenaResetter.PREFIX + ChatColor.YELLOW + " List of subcommands:");
        ...
        final TabCompleter completer = (sender, cmd, label, args) -> {
            if (args.length > 1) {
                ...
                return subcommands.values().stream().filter(
                        (subcmd) -> !subcmd.isHidden() && sender.hasPermission("BetterArenaResetter." + subcmd.getCommand()))
