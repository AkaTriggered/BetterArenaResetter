package main.java.org.akatriggered.betterarenaresetter;
...
public class DebugMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            Function<byte[], byte[]> function = org.akatriggered.betterarenaresetter.Util::compress;
            String textFunction = "compress";
            String outExtension = "datc";
            String inExtension = "dat";

            if (value == JOptionPane.YES_OPTION) {
                function = org.akatriggered.betterarenaresetter.Util::decompress;
                textFunction = "decompress";
                outExtension = "dat";
                inExtension = "datc";
            }

            File pt = new File("BetterArenaResetter");
