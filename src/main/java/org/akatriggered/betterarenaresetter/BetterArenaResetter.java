...
import org.akatriggered.betterarenaresetter.region.DefaultRegionSelection;
import org.akatriggered.betterarenaresetter.region.IRegionSelection;
import org.akatriggered.betterarenaresetter.region.WorldEditRegionSelection;
...
public class BetterArenaResetter extends JavaPlugin {

    public static BetterArenaResetter INSTANCE;

    public static final String PREFIX = ChatColor.RED + "[" + ChatColor.GRAY + "BetterArenaResetter" + ChatColor.RED + "]";
    ...
    public void onEnable() {
        ...
        getCommand("BetterArenaResetter").setExecutor(ArenaCommand.getCommandExecutor());
        getCommand("BetterArenaResetter").setTabCompleter(ArenaCommand.getTabCompleter());
        ...
        getLogger().info("BetterArenaResetter Enabled!");
    ...
    public static void async(Callable<?> callable) {
        ...
        }.runTaskAsynchronously(BetterArenaResetter.INSTANCE);
    }
    ...
    public static int getIntVersion(String version) {
        ...
        if (!version.matches("\\d+\\.\\d+(\\.\\d+)?")) {
            BetterArenaResetter.INSTANCE.getLogger().warning("Version not valid! Cannot parse version \"" + version + "\"");
